...
import org.roo.inaction.model.TagDataOnDemand;
...
privileged aspect TagIntegrationTest_Roo_IntegrationTest {
    ...
    public void TagIntegrationTest.testCountTags() {
        ...
        long count = org.roo.inaction.model.Tag.countTags();
    ...
    public void TagIntegrationTest.testFindTag() {
        org.roo.inaction.model.Tag obj = dod.getRandomTag();
        ...
        obj = org.roo.inaction.model.Tag.findTag(id);
    ...
    public void TagIntegrationTest.testFindAllTags() {
        ...
        java.util.List<org.roo.inaction.model.Tag> result = org.roo.inaction.model.Tag.findAllTags();
    ...
    public void TagIntegrationTest.testFindTagEntries() {
        ...
        java.util.List<org.roo.inaction.model.Tag> result = org.roo.inaction.model.Tag.findTagEntries(0, (int) count);
    ...
    public void TagIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyTag(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.roo.inaction.model.Tag merged =  obj.merge();
        obj.flush();
    ...
    public void TagIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Tag' failed to initialize correctly", dod.getRandomTag());
        org.roo.inaction.model.Tag obj = dod.getNewTransientTag(Integer.MAX_VALUE);
    ...
    public void TagIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Tag' with identifier '" + id + "'", org.roo.inaction.model.Tag.findTag(id));
    }
